...
export function SignUpScreen({ onSignUpSuccess, onLoginClick, onGuestContinue }: SignUpScreenProps) {
  ...
  return (
    <div className="size-full bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex flex-col items-center justify-center px-6 overflow-auto py-8">
      {/* App Icon - Removed */}

      {/* Welcome Text */}
      <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">Create Account</h1>
      <p className="text-gray-600 mb-6 text-center">Start your learning journey today</p>
