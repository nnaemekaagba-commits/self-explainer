          ...
          {step.diagram && (
            <div className="p-3 bg-green-50 border-2 border-green-300 rounded-lg">
              ...
              <div className="text-[13px] text-gray-800 leading-relaxed">
                Use the visual to spot givens, labels, and relationships before you complete this step yourself.
              </div>
            </div>
          )}
            ...
            <div className="p-3 bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-purple-300 rounded-lg">
              ...
              {step.diagramGenerated && (
                <p className="text-[10px] text-purple-700 mt-1 italic">
                  Review the setup only, then do the reasoning yourself.
                </p>
              )}
            </div>
          )}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-green-50 rounded-xl p-4 shadow-sm border border-green-200">
            <div className="text-[14px] text-green-900 mb-2">
              ...
              <div className="mt-2">
                <RenderableMathBlock content={userQuestion || "[Problem statement]"} className="inline-block align-middle" />
              </div>
            </div>
          </div>
