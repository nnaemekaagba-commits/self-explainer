                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                      ...
                      {step.diagram && (
                        <div className="mt-2 p-2 bg-green-50 rounded border border-green-300">
                          <p className="text-[10px] text-green-900 font-bold mb-1">Visual Hint:</p>
                          <div className="text-[11px] text-gray-700">
                            Use the diagram as a setup cue, not as a completed step.
                          </div>
                        </div>
                      )}
                      ...
                      {step.diagramUrl && (
                        <div className="mt-2 p-2 bg-gradient-to-br from-blue-50 to-purple-50 rounded border-2 border-purple-300">
                          <p className="text-[10px] text-purple-900 font-bold mb-1">AI-Generated Diagram Hint:</p>
